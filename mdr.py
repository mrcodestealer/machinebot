...
load_dotenv()
# ================= Configuration =================
# MDR sheet may be shared with a different Lark app than this bot's own —
# MDR_APP_ID/MDR_APP_SECRET override APP_ID/APP_SECRET when set in .env.
APP_ID = (os.getenv("MDR_APP_ID") or os.getenv("APP_ID") or "").strip()
APP_SECRET = (os.getenv("MDR_APP_SECRET") or os.getenv("APP_SECRET") or "").strip()
